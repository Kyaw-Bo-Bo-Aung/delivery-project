    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
       ...
       {{--  <li><a class="app-menu__item" href="docs.html"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Docs</span></a></li> --}}
        <li><a class="app-menu__item {{ Request::is('producttypes*') ? 'active' : '' }}" href="{{route('producttypes.index')}}"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Product_Types</span></a></li>
        <li><a class="app-menu__item {{ Request::is('packagingtypes*') ? 'active' : '' }}" href="{{route('packagingtypes.index')}}"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Packaging_Types</span></a></li>
         <li><a class="app-menu__item {{ Request::is('orders*') ? 'active' : '' }}" href="{{route('orders.index')}}"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Orders</span></a></li>
          <li><a class="app-menu__item {{ Request::is('usersdetail') ? 'active' : '' }}" href="{{route('usersdetailpage')}}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Users Detail</span></a></li>
          <li><a class="app-menu__item {{ Request::is('deliverydetail') ? 'active' : '' }}" href="{{route('deliverydetailpage')}}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Delivery Detail</span></a></li>
